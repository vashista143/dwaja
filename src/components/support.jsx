...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: `/founder.png`, text: 'Bharat -founder DHWAJA FLARE' },
      { image: `https://picsum.photos/seed/2/800/600?grayscale`, text: 'Desk Setup' },
      { image: `https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQjPPnf4S5VUOenAE-wNbpQE2mHU33FbiibRYMu0cS4Rg&s=10`, text: 'office Dhwaja flare' },
...
class App {
  constructor(
    ...
    const maxScroll =
      (this.medias.length - 1) * this.medias[0].width;

    this.scroll.target = Math.max(
      0,
      Math.min(this.scroll.target, maxScroll)
    );
  }
  createRenderer() {
    this.renderer = new Renderer({
